...
public class JAVATextContent {
    ...
    public static String Generating = "package ink.ikx.rt.api.mods.cote.flower.generating;\n"
        ...
        + "            subtile.onBlockPlaceBy.call(new MCWorld(world), new MCBlockPos(pos), new MCBlockState(state), EntityHelper.getIEntityLivingBase(entity), new MCItemStack(stack));\n"
        + "        }\n"
        + "    }\n"
        + "\n"
        + "    @Override\n"
